...
public class AudioEntryPlayback {
     ...
     * @param entry
     */
    public AudioEntryPlayback(@NonNull View itemView, Entry entry) {
        ...
        playButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!mediaPlayer.isPlaying()) { // If paused
                    ...
                    Drawable pauseD = MainActivity.getContext().getDrawable(android.R.drawable.ic_media_pause); // Getting pause drawable
    ...
    private void stopMediaPlayer() {
        ...
        if (mediaPlayer != null) {
            ...
            Drawable playD = MainActivity.getContext().getDrawable(android.R.drawable.ic_media_play);
